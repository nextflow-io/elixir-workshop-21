...
In the previous example, processes **A**, **B** and **C** can be run in parallel and only when they **ALL** end the process **D** is triggered. A operator is used for gathering together all the elements generated by the channels 2, 3 and 4. 
